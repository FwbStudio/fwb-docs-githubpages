---
title: White Widow Common Errors | FWB Studio Docs
description: Fix common White Widow issues on FiveM.
---
...
| --- | --- | --- |
| Resource fails to start | Missing `fs_bridge` or `ox_lib` | Install dependencies and start them before `fs_whitewidow` |
...
Check F8 client console and server console for `fs_whitewidow` errors after restart.
