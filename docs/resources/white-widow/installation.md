...
description: Install White Widow on ESX, QBCore, or Qbox FiveM servers. Dependencies, server.cfg, and fs_whitewidow setup. FiveM White Widow weed shop script.
---
...
- **ESX**, **QBCore**, or **Qbox**
- Dependencies listed in `fs_whitewidow/fxmanifest.lua` (commonly `ox_lib`, `fs_bridge`, etc.)
