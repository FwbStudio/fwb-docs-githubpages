...
description: Install Nails Saloon on FiveM — dependencies and server.cfg. FiveM nails saloon script ESX QBCore.
---
...
4. Configure `fs_nailssaloon/config/` before first start.
