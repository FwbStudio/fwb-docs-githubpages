...
description: Install Nails Saloon on ESX, QBCore, or Qbox FiveM servers. Dependencies, server.cfg, and fs_nailssaloon setup. FiveM nails saloon script ESX QBCore.
---
...
- **ESX**, **QBCore**, or **Qbox**
- Dependencies listed in `fs_nailssaloon/fxmanifest.lua` (commonly `ox_lib`, `fs_bridge`, etc.)

## Install steps

1. Place `fs_nailssaloon` in `resources/[fs]/`.
