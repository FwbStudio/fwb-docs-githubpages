...
description: Watch Gun Jamming previews and purchase on Tebex. FiveM gun jamming script.
---
...
<div class="fwb-product-hero">
  ...
  <p class="fwb-product-hero__tagline">Premium Gun Jamming for FiveM — ESX, QBCore, and Qbox compatible.</p>
...
<div class="fwb-video-grid">
  <div class="fwb-video-card">
    <div class="fwb-video-card__frame">
      <iframe
        src="https://www.youtube.com/embed/3czXFYjad70"
        title="Showcase"
        loading="lazy"
...
| **Store** | [Buy on Tebex](https://fwbstudio.tebex.io/package/7426484) |
