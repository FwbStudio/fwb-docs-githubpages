...
description: Install Gun Jamming on ESX, QBCore, or Qbox FiveM servers. Dependencies, server.cfg, and fs_gunjamming setup. FiveM gun jamming script.
---
...
- **ESX**, **QBCore**, or **Qbox**
- Dependencies listed in `fs_gunjamming/fxmanifest.lua` (commonly `ox_lib`, `fs_bridge`, etc.)
