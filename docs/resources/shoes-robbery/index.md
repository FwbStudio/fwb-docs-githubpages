...
description: Watch Shoes Robbery previews and purchase on Tebex. FiveM shoes robbery script.
---

<div class="fwb-product-hero">
  <p class="fwb-product-hero__eyebrow">FiveM Script</p>
  <h1 class="fwb-product-hero__title">Shoes Robbery</h1>
  <p class="fwb-product-hero__tagline">Premium Shoes Robbery for FiveM — ESX, QBCore, and Qbox compatible.</p>
...
<div class="fwb-video-grid">
  <div class="fwb-video-card">
    <div class="fwb-video-card__frame">
      <iframe
        src="https://www.youtube.com/embed/nQJjRztYqiY"
        title="Showcase"
        loading="lazy"
...
| | |
| --- | --- |
| **Package** | `fs_shoesrobbery` |
| **Category** | FiveM Script |
| **Store** | [Buy on Tebex](https://fwbstudio.tebex.io/package/7426476) |
