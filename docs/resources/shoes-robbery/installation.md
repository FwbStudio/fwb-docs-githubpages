...
description: Install Shoes Robbery on ESX, QBCore, or Qbox FiveM servers. Dependencies, server.cfg, and fs_shoesrobbery setup. FiveM shoes robbery script.
---
...
- **ESX**, **QBCore**, or **Qbox**
- Dependencies listed in `fs_shoesrobbery/fxmanifest.lua` (commonly `ox_lib`, `fs_bridge`, etc.)
