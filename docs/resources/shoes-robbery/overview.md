...
description: Shoes Robbery overview for FiveM servers — features, frameworks, and documentation links. FiveM shoes robbery script.
---

# Shoes Robbery — Overview

Official FWB Studio documentation for **Shoes Robbery**.
