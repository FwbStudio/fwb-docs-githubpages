...
description: Watch ChopShop previews and purchase on Tebex. FiveM chop shop script ESX QBCore.
---

<div class="fwb-product-hero">
  <p class="fwb-product-hero__eyebrow">FiveM Script</p>
  <h1 class="fwb-product-hero__title">ChopShop</h1>
  <p class="fwb-product-hero__tagline">Premium ChopShop for FiveM — ESX, QBCore, and Qbox compatible.</p>
...
<div class="fwb-video-grid">
  <div class="fwb-video-card">
    <div class="fwb-video-card__frame">
      <iframe
        src="https://www.youtube.com/embed/4xEzaqSHHwc"
        title="Showcase"
        loading="lazy"
...
| **Store** | [Buy on Tebex](https://fwbstudio.tebex.io/package/7426482) |
