...
description: Install Switch on ESX, QBCore, or Qbox FiveM servers. Dependencies, server.cfg, and fs_switch setup. FiveM gun switch script.
---
...
- **ESX**, **QBCore**, or **Qbox**
- Dependencies listed in `fs_switch/fxmanifest.lua` (commonly `ox_lib`, `fs_bridge`, etc.)
