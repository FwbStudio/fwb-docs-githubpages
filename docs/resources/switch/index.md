...
description: Watch Switch previews and purchase on Tebex. FiveM gun switch script.
---

<div class="fwb-product-hero">
  <p class="fwb-product-hero__eyebrow">FiveM Script</p>
  <h1 class="fwb-product-hero__title">Switch</h1>
  <p class="fwb-product-hero__tagline">Premium Switch for FiveM — ESX, QBCore, and Qbox compatible.</p>
...
<div class="fwb-video-grid">
  <div class="fwb-video-card">
    <div class="fwb-video-card__frame">
      <iframe
        src="https://www.youtube.com/embed/ilRQLepOyJM"
        title="Showcase"
        loading="lazy"
...
| **Store** | [Buy on Tebex](https://fwbstudio.tebex.io/package/7426485) |
