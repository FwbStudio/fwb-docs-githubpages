...
description: Install Npc Medic on ESX, QBCore, or Qbox FiveM servers. Dependencies, server.cfg, and fs_npcmedic setup. FiveM NPC medic script.
---
...
- **ESX**, **QBCore**, or **Qbox**
- Dependencies listed in `fs_npcmedic/fxmanifest.lua` (commonly `ox_lib`, `fs_bridge`, etc.)
