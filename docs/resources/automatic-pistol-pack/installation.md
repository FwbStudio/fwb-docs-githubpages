...
description: Install Automatic Pistol Pack on your FiveM server — weapon meta files, stream assets, and server.cfg order. FiveM automatic pistol weapon pack install.
---
...
1. Extract `fs_weapons_gangautopistol_v1` into `resources/[fs]/` (or your scripts folder).
