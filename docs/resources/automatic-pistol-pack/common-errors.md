---
title: Automatic Pistol Pack Common Errors & FAQ | FWB Studio Docs
description: Frequently asked questions, troubleshooting, and common error fixes for FiveM Automatic Pistol Pack script.
---

# Automatic Pistol Pack — Common Errors & FAQ

Have a question or encounter an issue while running **fs_weapons_gangautopistol_v1**? Check the common questions and error solutions below.
...
::: danger Cause
This error occurs because `fs_bridge` is missing, not started, or not running on your server before **fs_weapons_gangautopistol_v1** initializes.
:::
...
3. Open `fs_weapons_gangautopistol_v1/[INSTALL_ME_FIRST]` and use the item/sql blocks for your inventory system.
