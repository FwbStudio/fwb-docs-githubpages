...
description: Frequently asked questions, troubleshooting, and common error fixes for FiveM Trap Phone v2 script.
---
...
::: danger Cause
This error occurs because `fs_bridge` is missing, not started, or not running on your server before **fs_trapphone_v2** initializes.
:::
...
3. Open `fs_trapphone_v2/[INSTALL_ME_FIRST]` and use the item/sql blocks for your inventory system.
