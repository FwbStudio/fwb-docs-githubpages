...
description: Install Weave Wear Wig Carting on ESX, QBCore, or Qbox FiveM servers. Dependencies, server.cfg, and fs_weavewear_V1 setup. FiveM weave wear wig script.
---
...
- **ESX**, **QBCore**, or **Qbox**
- Dependencies listed in `fs_weavewear_V1/fxmanifest.lua` (commonly `ox_lib`, `fs_bridge`, etc.)
