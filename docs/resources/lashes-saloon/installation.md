...
description: Install Lashes Saloon on FiveM — dependencies, optional job setup, qb-clothing event, and server.cfg.
---
...
Lashes Saloon does not require inventory items, but if you want to run the salon as a player-owned business with society payout features:

1. Open `fs_lashessaloon/[INSTALL_ME_FIRST]`.
...
6. Configure `fs_lashessaloon/config/` settings before starting.
