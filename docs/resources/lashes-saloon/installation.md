...
description: Install Lashes Saloon on FiveM — dependencies and server.cfg. FiveM lashes saloon script.
---
...
4. Configure `fs_lashessaloon/config/` before first start.
