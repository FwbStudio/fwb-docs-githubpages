...
description: Lashes Saloon overview for FiveM servers — features, frameworks, and documentation links. FiveM lashes saloon script.
---

# Lashes Saloon — Overview

Official FWB Studio documentation for **Lashes Saloon**.
