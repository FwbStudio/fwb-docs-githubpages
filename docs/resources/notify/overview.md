...
description: Notify features and setup overview for FiveM. FiveM notify system FWB Studio.
---
...
**Notify** (`fs_notify`) — Team FwB Studio @ https://discord.gg/sPqkfQHPAa
