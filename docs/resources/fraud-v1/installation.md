...
description: Install Fraud System v1 on ESX, QBCore, or Qbox FiveM servers. Dependencies, server.cfg, and fs_fraud_v1 setup. FiveM fraud script v1 ESX QBCore.
---
...
- **ESX**, **QBCore**, or **Qbox**
- Dependencies listed in `fs_fraud_v1/fxmanifest.lua` (commonly `ox_lib`, `fs_bridge`, etc.)
