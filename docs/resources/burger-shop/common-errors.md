---
title: Burger Shop Common Errors & FAQ | FWB Studio Docs
description: Frequently asked questions, troubleshooting, and common error fixes for FiveM Burger Shop script.
---

# Burger Shop — Common Errors & FAQ

Have a question or encounter an issue while running **fs_burgershop**? Check the common questions and error solutions below.
...
::: danger Cause
This error occurs because `fs_bridge` is missing, not started, or not running on your server before **fs_burgershop** initializes.
:::
...
3. Open `fs_burgershop/[INSTALL_ME_FIRST]` and use the item/sql blocks for your inventory system.
