...
description: Install Burger Shop on ESX, QBCore, or Qbox FiveM servers. Dependencies, server.cfg, and fs_burgershop_V1 setup. FiveM burger shop job script.
---
...
- **ESX**, **QBCore**, or **Qbox**
- Dependencies listed in `fs_burgershop_V1/fxmanifest.lua` (commonly `ox_lib`, `fs_bridge`, etc.)
