...
description: Install Bodybag on ESX, QBCore, or Qbox FiveM servers. Dependencies, server.cfg, and fs_bodybag setup. FiveM bodybag script ESX QBCore.
---
...
- **ESX**, **QBCore**, or **Qbox**
- Dependencies listed in `fs_bodybag/fxmanifest.lua` (commonly `ox_lib`, `fs_bridge`, etc.)
