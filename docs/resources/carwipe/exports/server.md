---
title: Carwipe Server Exports | FWB Studio Docs
description: Server exports for FiveM Carwipe script.
---
...
Triggers a vehicle wipe. Can be called from custom admin menus or external server scripts to initiate a car cleanup. Note: This export executes the wipe immediately without checking admin permissions.
