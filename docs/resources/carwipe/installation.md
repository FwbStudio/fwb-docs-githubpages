---
title: Carwipe Installation | FWB Studio Docs
description: Install Carwipe on ESX, QBCore, or Qbox FiveM servers. Dependencies, server.cfg, and fs_carwipe setup. FiveM car wipe admin script.
---

# Carwipe — Installation
...
- **ESX**, **QBCore**, or **Qbox**
- Dependencies listed in `fs_carwipe/fxmanifest.lua` (commonly `ox_lib`, `fs_bridge`, etc.)
