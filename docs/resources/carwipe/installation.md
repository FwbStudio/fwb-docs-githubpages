...
description: Install Carwipe on FiveM — dependencies and server.cfg. FiveM car wipe admin script.
---
...
4. Check `fs_carwipe/[INSTALL_ME_FIRST]` for any database SQL setup.
5. Configure `fs_carwipe/config/` settings before starting.
