...
description: Install Smoking on ESX, QBCore, or Qbox FiveM servers. Dependencies, server.cfg, and fs_smoking setup. FiveM smoking script ESX QBCore.
---
...
- **ESX**, **QBCore**, or **Qbox**
- Dependencies listed in `fs_smoking/fxmanifest.lua` (commonly `ox_lib`, `fs_bridge`, etc.)
