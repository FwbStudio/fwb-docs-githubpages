...
description: Install Safezone Creator on ESX, QBCore, or Qbox FiveM servers. Dependencies, server.cfg, and fs_safezonecreator setup. FiveM safezone creator script.
---
...
- **ESX**, **QBCore**, or **Qbox**
- Dependencies listed in `fs_safezonecreator/fxmanifest.lua` (commonly `ox_lib`, `fs_bridge`, etc.)
