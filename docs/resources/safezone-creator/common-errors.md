...
description: Frequently asked questions, troubleshooting, and common error fixes for FiveM Safezone Creator script.
---
...
::: danger Cause
This error occurs because `fs_bridge` is missing, not started, or not running on your server before **fs_safezonecreator** initializes.
:::
...
3. Open `fs_safezonecreator/[INSTALL_ME_FIRST]` and use the item/sql blocks for your inventory system.
