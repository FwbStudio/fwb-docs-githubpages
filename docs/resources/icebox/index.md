---
title: Icebox Preview | FWB Studio Docs
description: Icebox preview and Tebex purchase. FiveM icebox jewelry script.
---


<div class="fwb-product-hero">
  <p class="fwb-product-hero__eyebrow">FiveM Script</p>
  <h1 class="fwb-product-hero__title">Icebox</h1>
  <p class="fwb-product-hero__tagline">Official Icebox for FiveM — ESX, QBCore, and Qbox.</p>
