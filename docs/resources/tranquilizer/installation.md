...
description: Install Tranquilizer on ESX, QBCore, or Qbox FiveM servers. Dependencies, server.cfg, and fs_tranquilizer setup. FiveM tranquilizer script.
---
...
- **ESX**, **QBCore**, or **Qbox**
- Dependencies listed in `fs_tranquilizer/fxmanifest.lua` (commonly `ox_lib`, `fs_bridge`, etc.)
