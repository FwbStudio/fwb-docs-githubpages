...
description: Install Outfitbag on ESX, QBCore, or Qbox FiveM servers. Dependencies, server.cfg, and fs_outfitbag setup. FiveM outfit bag wardrobe script.
---
...
- **ESX**, **QBCore**, or **Qbox**
- Dependencies listed in `fs_outfitbag/fxmanifest.lua` (commonly `ox_lib`, `fs_bridge`, etc.)
