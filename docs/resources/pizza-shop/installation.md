...
Open `fs_pizzashop/[INSTALL_ME_FIRST]` and use the block for **your** inventory system.
...
4. Complete **Items & inventory setup** by opening `fs_pizzashop/[INSTALL_ME_FIRST]` and adding the items to your inventory system.
5. Configure `fs_pizzashop/config/` settings before starting.
