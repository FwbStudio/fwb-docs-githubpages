...
description: Install Pizza Shop on ESX, QBCore, or Qbox FiveM servers. Dependencies, server.cfg, and fs_pizzashop_V1 setup. FiveM pizza shop job script.
---
...
- **ESX**, **QBCore**, or **Qbox**
- Dependencies listed in `fs_pizzashop_V1/fxmanifest.lua` (commonly `ox_lib`, `fs_bridge`, etc.)
